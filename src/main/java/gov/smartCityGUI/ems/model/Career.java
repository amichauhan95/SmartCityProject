package gov.smartCityGUI.ems.model;
...
public class Career {
  ...
  **/
  public void readFile() throws FileNotFoundException {
    try {
      Scanner sc = new Scanner("src/main/java/gov/smartCityGUI/ems/data/careers.txt");
  ...
  **/
  public void writeToFile(ArrayList<String> newApplicant) throws IOException {
    try {
      fw = new FileWriter("src/main/java/gov/smartCityGUI/ems/data/applicants.txt", true);
  ...
  **/
  ...
  public String toString() {
    return getFirstName() + ", " + getLastName() + ", " + getEmail() + ", " + getPhoneNumber() + ", " + getDOB() + ", " + getPosition() + ", " + getCoverLetter();
  }
}