...
// /**
// * @throws Exception if the file isn't read from properly
// * public void createFrame() creates the main frame for the GUI
// **/
...
// } catch (Exception err) {
// err.printStackTrace();
// JOptionPane.showMessageDialog(frame, "An error occurred while reading the
...
// /**
// * public void actionPerformed(ActionEvent e) displays a window based on the
// selection from the user
// * @param ActionEvent e represents the action that occurs when the user clicks
// a button
// **/
